...
def get_pmi_dict(texts_tokenized):
    ...
    :param texts_tokenized: Corpus reviews.
    :type texts_tokenized: list
    ...
    context_dict = preprocessing.get_all_context_words(texts_tokenized, constants.CONTEXT_WINDOW_SIZE)
...
def prepare_pmi(revs):
    ...
    print("The PMI Matrix has been generated.")
