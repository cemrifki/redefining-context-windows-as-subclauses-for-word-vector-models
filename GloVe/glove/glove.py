...
class Glove(object):
    ...
    def __init__(self, no_components=30, learning_rate=0.05,
        ...
        - float max_loss: the maximum absolute value of calculated
                          ...
                          stability.
        - random_state: random statue used to initialize optimization
        """
        ...
        self.words_and_vectors = None

        self.random_state = random_state

    def fit(self, matrix, epochs=5, no_threads=2, verose=False):
        """
        ...
        - bool verose: print progress messages if True
        """
    ...
    def combine_words_and_vectors(self):
        self.words_and_vectors = dict(zip(self.dictionary.keys(), self.word_vectors))
